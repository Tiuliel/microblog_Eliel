...
if(isset($_POST["atualizar"])){
    ...
    /*  Se o campo imagem estiver vazio, então significa que o usuário NÃO QUER TROCAR A IMAGEM. por tanto vamos manter a imagem existente. */
        ...
        <form class="mx-auto w-75" action="" method="post" id="form-atualizar" name="form-atualizar" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <?php foreach($listaDeCategorias as $itemCategoria) { ?>
					<option
                    <?php if($dados["categoria_id"] === $itemCategoria["id"]) echo "selected" ?> value="<?=$itemCategoria['id']?>">
						<?=$itemCategoria['nome']?>
					</option>
				<?php } ?>
